...
import static com.net.Main.spiralDataX;
import static com.net.Main.spiralDatay;
...
public class IntegrationTest {
    ...
    public void backpropagationCompleteNetwork() {
        ...
        lossActivation.forward(dense2.output, Tools.convertToOneHot(spiralDatay(), 3));

        //backpropagation
        lossActivation.backward(lossActivation.output, Tools.convertToOneHot(spiralDatay(), 3));
    ...
    public void backpropagationOptimizer(){
        ...
        activation1.forward(dense1.output);
        dense2.forward(activation1.output);
        double loss = lossActivation.forward(dense2.output, Tools.convertToOneHot(spiralDatay(), 3));
