...
#print("loss activation dinout", loss_activation.dinputs)
dense2.backward(loss_activation.dinputs)


#print("dense2 dinputs", dense2.dinputs)
activation1.backward(dense2.dinputs)
#print("activation1 dinputs", activation1.dinputs)

dense1.backward(activation1.dinputs)
#print("dense1 dinputs", dense1.dinputs)
# Print gradients
...
print('updated dense1')
print(dense1.weights)
print(dense1.biases)
print('updated dense2')
print(dense2.weights)
print(dense2.biases)
